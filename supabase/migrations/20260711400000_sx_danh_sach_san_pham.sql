...
-- Thuộc tính phải thuộc junction danh mục của sản phẩm
...
COMMENT ON TABLE public.sx_danh_sach_san_pham IS 'Danh sách hàng hóa / sản phẩm may mặc';
COMMENT ON TABLE public.sx_san_pham_thuoc_tinh IS 'Giá trị thuộc tính theo sản phẩm (kế thừa từ danh mục cấp 2)';
