-- Junction: danh mục cấp 2 ↔ thuộc tính / thông số đo
-- ============================================================================
...
-- Chỉ danh mục cap_do = 2 được gán link
...
COMMENT ON TABLE public.sx_danh_muc_thuoc_tinh IS 'Thuộc tính gán cho danh mục hàng hóa cấp 2';
COMMENT ON TABLE public.sx_danh_muc_thong_so_do IS 'Thông số đo gán cho danh mục hàng hóa cấp 2';
