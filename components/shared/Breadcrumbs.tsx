...
const getRouteConfig = (t: TFunction): Record<string, RouteConfig> => ({
  ...
  '/kinh-doanh/don-hang': { label: t('breadcrumb.salesOrder'), parentPath: '/kinh-doanh' },
  '/kinh-doanh/bao-cao-ban-hang': { label: t('breadcrumb.salesReport'), parentPath: '/kinh-doanh' },
  '/kinh-doanh/mua-nguyen-lieu': { label: t('breadcrumb.materialPurchase'), parentPath: '/kinh-doanh' },
  '/kinh-doanh/danh-sach-khach-hang': { label: t('breadcrumb.customerList'), parentPath: '/kinh-doanh' },
  '/kinh-doanh/bao-cao-cong-no-khach-hang': {
    label: t('breadcrumb.customerDebtReport'),
    parentPath: '/kinh-doanh',
  },
  '/kinh-doanh/danh-sach-nha-cung-cap': { label: t('breadcrumb.supplierList'), parentPath: '/kinh-doanh' },
  '/kinh-doanh/bao-cao-cong-no-nha-cung-cap': {
    label: t('breadcrumb.supplierDebtReport'),
    parentPath: '/kinh-doanh',
  },
  '/san-xuat': { label: t('breadcrumb.production'), parentPath: '/' },
  '/san-xuat/lenh-san-xuat': { label: t('breadcrumb.productionOrder'), parentPath: '/san-xuat' },
  '/san-xuat/bao-cao-san-xuat': { label: t('breadcrumb.productionReport'), parentPath: '/san-xuat' },
  '/san-xuat/phieu-kho': { label: t('breadcrumb.warehouseSlip'), parentPath: '/san-xuat' },
  ...
  '/san-xuat/thong-so-do': { label: t('breadcrumb.measurementSpec'), parentPath: '/san-xuat' },
  '/san-xuat/bom': { label: t('breadcrumb.bom'), parentPath: '/san-xuat' },
  '/tai-chinh': { label: t('breadcrumb.finance'), parentPath: '/' },
  '/tai-chinh/so-thu-chi': { label: t('breadcrumb.financeLedger'), parentPath: '/tai-chinh' },
  '/tai-chinh/tai-khoan': { label: t('breadcrumb.financeAccount'), parentPath: '/tai-chinh' },
  '/tai-chinh/danh-muc-tai-chinh': { label: t('breadcrumb.financeCategory'), parentPath: '/tai-chinh' },
  '/tai-chinh/tra-cuu-tai-khoan': { label: t('breadcrumb.financeAccountLookup'), parentPath: '/tai-chinh' },
  '/tai-chinh/bao-cao-tai-chinh': { label: t('breadcrumb.financeReport'), parentPath: '/tai-chinh' },
  ...
  '/he-thong/chi-nhanh': { label: t('breadcrumb.branch'), parentPath: '/he-thong' },
