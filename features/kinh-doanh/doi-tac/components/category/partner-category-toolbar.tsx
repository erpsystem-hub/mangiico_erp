...
import { countPartnerCategoryColumnSearchActive } from '../../utils/column-search';
...
const PartnerCategoryToolbar: React.FC<Props> = ({
  categoryResource,
  categories,
  selectedCount,
  onAdd,
  ...
  const activeFilterCount = useMemo(() => {
    const colN = countPartnerCategoryColumnSearchActive(filters.columnSearch);
...
export default PartnerCategoryToolbar;
