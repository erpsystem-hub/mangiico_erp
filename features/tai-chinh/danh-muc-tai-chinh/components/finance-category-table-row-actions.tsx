...
export interface FinanceCategoryTableRowActionsProps {
...
export function FinanceCategoryTableRowActions({
  item,
  menuOpenId,
  onMenuOpenChange,
  onEdit,
  ...
  canDelete,
  compact = false,
}: FinanceCategoryTableRowActionsProps) {
  const close = () => onMenuOpenChange(null);
  const toggleLabel =
    item.trang_thai === 'Đang hoạt động'
      ? txt('financeCategory.detail.deactivate')
      : txt('financeCategory.detail.activate');
