...
export interface FinanceAccountTableRowActionsProps {
  item: FinanceAccount;
...
export function FinanceAccountTableRowActions({
  item,
  menuOpenId,
  onMenuOpenChange,
  onEdit,
  ...
  onStatusChange,
  compact = false,
}: FinanceAccountTableRowActionsProps) {
  const close = () => onMenuOpenChange(null);
  const canEdit = useCan('edit', 'financeAccounts');
  const canDelete = useCan('delete', 'financeAccounts');
