...
import { countProductCatalogColumnSearchActive } from '../utils/column-search';
...
const ProductCatalogToolbar: React.FC<Props> = ({
  categories,
  items,
  onAdd,
  onDeleteMany,
  ...
  const { canCreate, canDelete, canEdit } = useResourcePermissions('productCatalog');
  ...
  const activeFilterCount = useMemo(() => {
    const colN = countProductCatalogColumnSearchActive(filters.columnSearch);
    return (
      (searchTerm ? 1 : 0) +
      colN +
