...
export const ui = {
  "nav": {
    "changePassword": {
      ...
      "errorSamePassword": "Mật khẩu mới phải khác mật khẩu hiện tại."
    },
    "home": "Trang chủ",
    "back": "Quay lại",
    ...
    "logoutCancel": "Hủy bỏ",
    "defaultAppDescription": "An toàn thông tin · Truy cập có kiểm soát",
  ...
  "page": {
    ...
    "login": {
      ...
      "footer": "Truy cập được mã hóa SSL · Chỉ dành cho cán bộ được cấp quyền · Tuân thủ quy định an toàn thông tin",
      ...
      "errorAccountNotFound": "Tài khoản không tồn tại. Kiểm tra tên đăng nhập hoặc liên hệ quản trị viên.",
      "errorAccountLocked": "Tài khoản đã bị khoá. Liên hệ quản trị viên.",
      "errorEmailNotConfirmed": "Tài khoản chưa được kích hoạt. Liên hệ quản trị viên.",
      "errorAccountBanned": "Tài khoản bị cấm truy cập. Liên hệ quản trị viên.",
      "errorTooManyRequests": "Đăng nhập quá nhiều lần. Vui lòng thử lại sau vài phút.",
      "errorInvalidUsername": "Tên tài khoản không hợp lệ.",
      "errorWeakPassword": "Mật khẩu quá yếu. Vui lòng chọn mật khẩu mạnh hơn.",
      "errorAccountExists": "Tài khoản đã tồn tại trên hệ thống.",
      "errorGeneric": "Không thể đăng nhập. Vui lòng thử lại.",
      "errorFailed": "Đăng nhập thất bại.",
      "errorNotConfigured": "Chưa cấu hình xác thực. Liên hệ quản trị viên.",
      "errorEmployeeNotFound": "Không tìm thấy hồ sơ nhân viên trùng tên đăng nhập. Liên hệ quản trị viên.",
      "errorSessionInit": "Không thể khởi tạo phiên đăng nhập. Vui lòng thử lại."
    },
    "profile": {
    ...
    "businessDashboard": {
      ...
      "customerListDesc": "Nhóm KH, danh sách khách hàng và cài đặt hệ số giá (3 tab).",
